		...
		<main>
			...
			<section id="about-me">
				...
				<ul> 
					...
					<li class="certificaciones"><a href="https://drive.google.com/file/d/1FOvHvnjdTJsPlEjGuml28--SQfo1-8pE/view?usp=sharing" target="_blank">Argentina Programa #YoProgramo</a>, otorgado por el INTI, enfocado en lógica de programación orientada a objetos utlizando lenguajes como javasScript y Ruby.</li>
				...
				<div class="CV">
					<p><a href="https://drive.google.com/file/d/17ZtLnaj3kdJZYsDJ5oN5NrtLKxMSOoEx/view?usp=sharing" target="_blank">Descargar Curriculum Vitae </a></p>
				</div>
			</section>
			<section id="Skills">
				<div class="titulos">
